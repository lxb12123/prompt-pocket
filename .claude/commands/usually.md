---
description: Prompt Pocket — list your high-frequency prompts and pick one to run; manage your go-to prompts with add/delete/edit/find. Generates a native slash dropdown so you can pick a saved prompt directly.
